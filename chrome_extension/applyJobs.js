...
//     // Go to LinkedIn job search page with filters
//     const jobSearchURL = "https://www.linkedin.com/jobs/search/?keywords=frontend%20developer&location=Remote";
...
//             .map(link => link.href)
//             .slice(0, 5); // Apply to first 5 jobs
//     });
...
//     if (nameField) await nameField.type("John Doe");
//     if (emailField) await emailField.type("johndoe@example.com");
//     if (phoneField) await phoneField.type("+1234567890");
